...
const profileSchema = yup.object({
    ...
    password: yup.string().min(6, 'A senha deve conter no minimo 6 dígitos.').nullable().transform(value => !!value ? value : null),
...
export function Profile() {
    ...
    const { control, handleSubmit, formState: { errors } } = useForm<FormDateProps>({
        defaultValues: {
            name: user.name,
            email: user.email,
        },
    ...
    async function handleProfileUpdate(data: FormDateProps) {
        try {
            setIsUpdating(true);
        ...
        <VStack flex={1}>
            ...
            <ScrollView contentContainerStyle={{ paddingBottom: 36 }}>
                <Center mt={6} px={10}>
                    ...
                    <Heading color='gray.200' fontSize='md' fontFamily='heading' mt={12} mb={2} alignSelf='flex-start'>
                        Alterar senha
                    </Heading>
